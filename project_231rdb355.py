...
def failusortings():
    ...
    if user_choice == 'yeah':
        ...
        folderi = []
        ######### DELJ FOLDERIEM
        mape_del_mapem = os.path.join(scripta_loc, "Folders") #  izveido mapi ar nosaukumu Folders, kur pectam bus parvietoti folderi
        ...
        ######### FOLDERI BEIDZAS, SAKAS TIESHI FAILU SORTESHANA
        failu_tipi = {} # izveido dict lai saglabatu failu tipus un mapes
        ...
        for faila_tips, faili in failu_tipi.items(): #shis for cikls izveido katram failu tipam atsevisku folderi
            ...
            for faila_nosauk in faili:# sheit jau ir tas lai paarvietotu failus un folderus uz vinu folderiem izveidotajiem, seit izmantojas shutil biblioteka
                ...
                shutil.move(sakums, beigu_pozicija) 
        print("Sorting completed. Closing app. #GLHF")
        time.sleep(2)
    elif user_choice == 'nope':
        print("Why not? Okay, maybe next time buddy_)")
    else:
        print("You typed wrong, dude. Enter 'Yeah' or 'Nope'.")
